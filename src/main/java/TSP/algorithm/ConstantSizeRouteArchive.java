...
import TSP.Parallel.ArchiveInsertVertexTask;
import TSP.Route;
...
//        List<Route> list =new ArrayList<>(getRoutes());
//        ArchiveInsertVertexTask task= new ArchiveInsertVertexTask(result,list,i);
//        pool.invoke(task);
        return result;
    }
